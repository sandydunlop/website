...
<span style="font-family: monospace; font-size: 80%;">private void __outputEnumConstantsSummary__([EnumTypeNode](../model/EnumTypeNode.md) enumNode)</span>
...
<span style="font-family: monospace; font-size: 80%;">private void __outputNestedClassSummary__([List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html)<[TypeView](../model/TypeView.md)> nestedClasses)</span>
