...
| public static boolean                                                                                      | [isSubtype](#issubtype)([VariableType](../model/VariableType.md) typeA, [VariableType](../model/VariableType.md) typeB)                                                             | Check if typeA is a subtype of typeB |
| public static boolean                                                                                      | [isAssignableFrom](#isassignablefrom)([VariableType](../model/VariableType.md) typeA, [VariableType](../model/VariableType.md) typeB)                                               | Check if typeA is subtype of typeB   |
| private static boolean                                                                                     | [parameterizedTypesAreCompatible](#parameterizedtypesarecompatible)([Generic](../model/VariableType.Generic.md) paramTypeA, [Generic](../model/VariableType.Generic.md) paramTypeB) |                                      |
...
<span style="font-family: monospace; font-size: 80%;">public static boolean __isSubtype__([VariableType](../model/VariableType.md) typeA, [VariableType](../model/VariableType.md) typeB)</span>
...
<span style="font-family: monospace; font-size: 80%;">public static boolean __isAssignableFrom__([VariableType](../model/VariableType.md) typeA, [VariableType](../model/VariableType.md) typeB)</span>
...
<span style="font-family: monospace; font-size: 80%;">private static boolean __parameterizedTypesAreCompatible__([Generic](../model/VariableType.Generic.md) paramTypeA, [Generic](../model/VariableType.Generic.md) paramTypeB)</span>
