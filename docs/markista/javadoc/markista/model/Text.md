...
|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|-----------------------------------------------------|
| private [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html)<[Segment](Text.Segment.md)> | [segments](#segments)                 | List of text segments composing this Text instance. |
...
| public static [Text](Text.md)                                                                                               | [of](#of)([Segment](Text.Segment.md) segment)                                                                        | Creates a Text object containing the supplied segment value |
...
| public [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html)<[Segment](Text.Segment.md)> | [getSegments](#getsegments)()                                                                                        | Returns the list of segments composing this Text.           |
| public [Segment](Text.Segment.md)                                                                                           | [getSegment](#getsegment)(int n)                                                                                     |                                                             |
| public void                                                                                                                 | [set](#set)([Text](Text.md) text)                                                                                    | Sets the segments of this Text to match another Text.       |
| public [Text](Text.md)                                                                                                      | [append](#append)([Segment](Text.Segment.md) segment)                                                                | Appends a single segment to this Text.                      |
...
<span style="font-family: monospace; font-size: 80%;">private [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html)<[Segment](Text.Segment.md)> __segments__</span>
...
`string` - a String to store in the Text object
...
<span style="font-family: monospace; font-size: 80%;">public static [Text](Text.md) __of__([Segment](Text.Segment.md) segment)</span>

Creates a Text object containing the supplied segment value

**Parameters:**

`segment` - a Segment to store in the Text object
...
<span style="font-family: monospace; font-size: 80%;">public [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html)<[Segment](Text.Segment.md)> __getSegments__()</span>
...
<span style="font-family: monospace; font-size: 80%;">public [Segment](Text.Segment.md) __getSegment__(int n)</span>
...
<span style="font-family: monospace; font-size: 80%;">public [Text](Text.md) __append__([Segment](Text.Segment.md) segment)</span>
