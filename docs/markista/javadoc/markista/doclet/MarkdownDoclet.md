...
| [DocService](../spi/DocService.md)                                                                                                                         | [getMainServiceAndExtensions](#getmainserviceandextensions)([ServiceLoader](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/ServiceLoader.html) loader, [DocService](../spi/DocService.md) defaultDocService, [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html) orderedExtensions)       | Populates the list of extensions and determines the main DocService.            |
| private [DocService](../spi/DocService.md)                                                                                                                 | [populateExtensionsWithOrder](#populateextensionswithorder)([ServiceLoader](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/ServiceLoader.html) loader, [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html) orderedExtensions, [DocService](../spi/DocService.md) defaultDocService)       |                                                                                 |
...
| private void                                                                                                                                               | [addExtensionToMap](#addextensiontomap)([HashMap](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/HashMap.html) extensions, [DocService](../spi/DocService.md) extension)                                                                                                                                                       |                                                                                 |
| private [DocService](../spi/DocService.md)                                                                                                                 | [handleExtension](#handleextension)([DocService](../spi/DocService.md) mainDocService, [DocService](../spi/DocService.md) defaultDocService, [List](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html) orderedExtensions, [DocService](../spi/DocService.md) extension)                                                 |                                                                                 |
...
<span style="font-family: monospace; font-size: 80%;">private void __addExtensionToMap__([HashMap](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/HashMap.html) extensions, [DocService](../spi/DocService.md) extension)</span>
